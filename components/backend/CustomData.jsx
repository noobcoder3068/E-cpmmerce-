    ...
    <div className='bg-slate-700 p-8 mt-8'>
      ...
      <div>
        <div className="relative overflow-x-auto shadow-md sm:rounded-lg">
          ...
          <nav
            className="flex items-center flex-column flex-wrap md:flex-row justify-between pt-4 z-0"
            aria-label="Table navigation"
          >
            <span className="text-sm font-normal text-gray-500 dark:text-gray-400 mb-4 md:mb-0 block w-full md:inline md:w-auto">
              Showing <span className="font-semibold text-gray-900 dark:text-white">
                {startItemIndex}-{endItemIndex}</span> of{' '}
            ...
            <ul className="inline-flex -space-x-px rtl:space-x-reverse text-sm h-8">
              ...
              <button 
                ...
                disabled={currentPage=== 1}
                  ...
                  px-3 h-8 leading-tight text-gray-500 
              ...
              <li>
                {
                    Array.from({length:total_pages}, (item,index)=>{
                        return(
                            <li key={index}>
                                <button onClick={()=>{setCurrentPage(index+1)}}
                                className="flex items-center justify-center
                                px-3 h-8 leading-tight text-gray-500 bg-white
